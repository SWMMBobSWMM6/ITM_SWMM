...
const
  ...
  MAXNODEPROPS     = 24;       //Max. index for node data array
  MAXLINKPROPS     = 28;       //Max. index for link data array
...
//------------------------
  ...
  JUNCTION_ITM_HEADING           = 12;
  JUNCTION_ITM_AREA_INDEX        = 13;
...
//-----------------------
  ...
  CONDUIT_ITM_HEADING        = 20;
  CONDUIT_ITM_INIT_TYPE_INDEX = 21;
  CONDUIT_ITM_INIT_DEPTH_INDEX = 22;

  CONDUIT_GEOM2_INDEX        = 23;
  CONDUIT_GEOM3_INDEX        = 24;
  CONDUIT_GEOM4_INDEX        = 25;
  CONDUIT_BARRELS_INDEX      = 26;
  CONDUIT_TSECT_INDEX        = 27;
...
//--------------------
  ...
  PUMP_ITM_HEADING         = 9;
  PUMP_ITM_SETTING_INDEX   = 10;
  PUMP_ITM_METHOD_INDEX    = 11;
  PUMP_ITM_TSERIES_INDEX   = 12;
  PUMP_ITM_NODE_INDEX      = 13;
  PUMP_ITM_CURVE_INDEX     = 14;
...
//-----------------------
  ...
  ORIFICE_ITM_HEADING       = 13;
  ORIFICE_ITM_SETTING_INDEX = 14;
  ORIFICE_ITM_METHOD_INDEX  = 15;
  ORIFICE_ITM_TSERIES_INDEX = 16;
  ORIFICE_ITM_NODE_INDEX    = 17;
  ORIFICE_ITM_CURVE_INDEX   = 18;
...
//--------------------
  ...
  WEIR_ITM_HEADING       = 19;
  WEIR_ITM_SETTING_INDEX = 20;
  WEIR_ITM_METHOD_INDEX  = 21;
  WEIR_ITM_TSERIES_INDEX = 22;
  WEIR_ITM_NODE_INDEX    = 23;
  WEIR_ITM_CURVE_INDEX   = 24;
  WEIR_SHAPE_INDEX       = 25;
...
//--------------
  ...
  public
    ...
    ItmOptions   : array [0..MAX_ITM_OPTIONS] of String;
    IDincrement  : Integer;
