...
//---------------
  ...
  ItmSwmmDir    : String;              // Executable directory
  ...
  TempItmInpFile : String;             // Name of ITM input file
  TempItmRptFile : String;             // Name of ITM report file
  TempItmLogFile : String;             // Name of ITM debug file
  TempItmOutFile : String;             // Name of ITM output file
  TempItmPltFile : String;             // Name of ITM plotting file
  UsesITM        : Boolean;            //True for ITM flow routing
//-------------------
// Map view variables
//-------------------
...
//-----------------------------------------------------------------------------
begin
  ItmSwmmDir := ExtractFilePath(Application.ExeName);
  ...
  Application.HelpFile := ItmSwmmDir + HLPFILE;
  TempDir := GetTempFolder;
  if TempDir = '' then TempDir := ItmSwmmDir;
  IniFileDir := Uutils.GetAppDataDir('ITMSWMM', ItmSwmmDir);
  InputFileName := '';
end;
