...
{   to the ITM SWMM INI file (itmswmm.ini) as well as for the       }
{   current project's INI file.                                     }
{                                                                   }
...
//  the ITMSWMM.INI file or a project ini file.
//-----------------------------------------------------------------------------
var
  I, J : Integer;
  S : String;
...
//  default properties from the ITMSWMM.INI file.
//-----------------------------------------------------------------------------
var
  I: Integer;
  theIniFile: TInifile;
begin
  ...
  begin
    ...
    Uutils.CopyStringArray(DefItmOptions, ItmOptions);
  end;
  ...
  // Read defaults from the ITMSWMM.INI file
...
procedure SaveDefaults;
//-----------------------------------------------------------------------------
//  Saves default properties to the ITMSWMM.INI file.
//-----------------------------------------------------------------------------
var
  theIniFile: TInifile;
begin
...
procedure ReadMainFormSize;
//-----------------------------------------------------------------------------
//  Reads main form's position and size from the ITMSWMM.INI file.
//-----------------------------------------------------------------------------
var
  L, T, W, H: Integer;
...
procedure SaveMainFormSize;
//-----------------------------------------------------------------------------
// Saves main form's position and size to the ITMSWMM.INI file.
//-----------------------------------------------------------------------------
var
  L, T, W, H: Integer;
  recWndPlmt : TWindowPlacement;
