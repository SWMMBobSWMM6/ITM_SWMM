  ...
  case Ltype of
    ...
    PUMP:
      begin
        ...
        PumpProps[PUMP_ITM_TSERIES_INDEX].List := Project.Lists[TIMESERIES].Text;
    ...
    ORIFICE:
      begin
        OrificeProps[ORIFICE_ITM_TSERIES_INDEX].List := Project.Lists[TIMESERIES].Text;
        OrificeProps[ORIFICE_ITM_CURVE_INDEX].List := Project.Lists[CONTROLCURVE].Text;
    ...
    WEIR:
      begin
        ...
        WeirProps[WEIR_ITM_TSERIES_INDEX].List := Project.Lists[TIMESERIES].Text;
