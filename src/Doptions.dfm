object AnalysisOptionsForm: TAnalysisOptionsForm
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet5: TTabSheet
      Caption = 'ITM'
      ImageIndex = 5
      object InitElevLabel: TLabel
        Left = 36
        Top = 242
        Width = 151
        Height = 15
        Caption = 'Global Initial Water Elevation'
      end
      object WaveCelerityLabel: TLabel
        Left = 36
        Top = 204
        Width = 122
        Height = 15
        Caption = 'Pressure Wave Celerity '
      end
      ...
      object Label37: TLabel
        ...
        Width = 176
        Height = 15
        Caption = 'Illinois Transient Model Options:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
        Font.Name = 'Segoe UI'
      ...
      object MaxCellsUpDn: TUpDown
        Left = 327
        Top = 87
        Width = 16
        Height = 23
        Associate = MaxCellsEdit
        Min = 10
        Max = 100000
        Increment = 10
        Position = 20
      ...
      object MaxPlotCellsUpDn: TUpDown
        Left = 327
        Top = 125
        Width = 16
        Height = 23
        Associate = MaxPlotCellsEdit
        Min = 1
        Position = 100
        TabOrder = 4
      end
      object RefDepthUpDn: TUpDown
        Left = 327
        Top = 163
        Width = 16
        Height = 23
        Associate = RefDepthEdit
        Min = 80
        Max = 99
        Position = 95
        TabOrder = 6
      end
      object RefDepthEdit: TEdit
        Left = 276
        Top = 163
        Width = 51
        Height = 23
      ...
      object ItmDefaultsLinkLabel: TLinkLabel
        Left = 36
        Top = 349
        Width = 81
        Height = 19
        ...
        TabOrder = 9
        TabStop = True
        OnLinkClick = ItmDefaultsLinkLabelLinkClick
      end
      object DebugFileBtn: TBitBtn
        Left = 320
        Top = 306
        Width = 23
        Height = 22
        ...
        ShowHint = True
        TabOrder = 10
        OnClick = DebugFileBtnClick
      end
      object DebugFileCB: TCheckBox
        Left = 36
        Top = 280
        Width = 147
        Height = 17
        Caption = 'Save debug file to:'
        TabOrder = 11
        OnClick = DebugFileCBClick
      end
      object DebugFileEdit: TEdit
        Left = 36
        Top = 306
        Width = 278
        Height = 23
